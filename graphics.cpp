...
void draw_img(int u, int v, const char* img)
{
    ...
    for (int i = 0; i < 11*11; i++)
    {
        ...
        //else if (img[i] == 'G') colors[i] = GREEN;
         ...
         else if (img[i] == 'G') colors[i] = LGREY;
...
char *bomb = "XXXXXXOXOXXXXXXXXXRRXOXXXXXXRXXOXXXXXXRXXOXXXXXXRRRXXXXXXXRRRRRXXXXXRRRGRRRXXXXRRGGGRRXXXXXRRGRRXXXXXXXRRRXXXXXXXXXXXXXXX";
void draw_bomb(boundingBox b)
{
    // Draw an apple using a filled_rectangle or get creative and use a sprite!
    draw_img(b.topLeft.x, b.topLeft.y, bomb);
}
